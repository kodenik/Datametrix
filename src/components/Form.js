...
export default function Form() {
  return (
    ...
    <div className='row' style={{backgroundColor:'#008B8B',height:'810px'}}>
      <div className='col-md-6' >
        ...
        <br/>
          <h5><p>
          <img src='/images/tick2.jpg'style={{width:'50px',height:'50px',marginLeft:'15px'}}/>&nbsp;&nbsp;
          ...
          <h5>
          <p><img src='/images/tick2.jpg'style={{width:'50px',height:'50px',marginLeft:'15px'}}/>&nbsp;&nbsp;
          ...
          <img src ='/images/circle-yellow.png' style={{marginLeft:'30px',marginTop:'250px',width:'23%'}}/>
  ...
  <label class="form-check-label square-checkbox" for="form4Example4">
  ...
  <center><button type="submit" class="btn  btn-block mb-4" id='button' style={{backgroundColor:'#008b8b'}}>Iam Ready</button></center>
</form>
</CardBody>
  </Card>
  </div>
